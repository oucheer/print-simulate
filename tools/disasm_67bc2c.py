# -*- coding: utf-8 -*-
"""round 79 静态：port913x_handler_thread(0x67bc2c)、bind_listen_66b0(0x66b000)、0x6765f8"""
import struct
...
disasm(0x67bc2c, 0x400, "port913x_handler_thread")
disasm(0x66b000, 0x500, "bind_listen_66b0")
